...
import com.dsi.ant.plugins.antplus.pcc.AntPlusGeocachePcc.GeocacheRequestStatusCode;
                        ...
                        boolean reqSubmitted = geoPcc.requestDeviceData(deviceID, true, 
                                ...
                                new IDataDownloadFinishedReceiver()
                                        {                                            
                                            ...
                                            public void onNewDataDownloadFinished(int statusCode, GeocacheDeviceData downloadedData)
                                            {
                                                StringBuilder error = new StringBuilder("Error Downloading Data: ");
                                                
                                                switch(statusCode)
                                                {
                                                    case GeocacheRequestStatusCode.SUCCESS:
                                                    ...
                                                    case GeocacheRequestStatusCode.FAIL_DEVICE_NOT_IN_LIST:
                                                        error.append("Device no longer in list");
                                                        break;
                                                    case GeocacheRequestStatusCode.FAIL_ALREADY_BUSY_EXTERNAL:
                                                        error.append("Device is busy");
                                                        break;
                                                    case GeocacheRequestStatusCode.FAIL_DEVICE_COMMUNICATION_FAILURE:
                                    ...
                                    int initialDeviceStateCode)
                            {
                                switch(resultCode)
                                {
                                    case AntPluginMsgDefines.MSG_REQACC_RESULT_whatSUCCESS:
                                        geoPcc = result;
                                        tv_status.setText(result.getDeviceName() + ": " + AntPlusGeocachePcc.statusCodeToPrintableString(initialDeviceStateCode));
                            ...
                            public void onDeviceStateChange(final int newDeviceState)
                            {
                                runOnUiThread(new Runnable()
                                        {                                            
                                            ...
                                            public void run()
                                            {
                                                tv_status.setText(geoPcc.getDeviceName() + ": " + AntPlusGeocachePcc.statusCodeToPrintableString(newDeviceState));
                ...
                new IAvailableDeviceListReceiver()
                        {
                            ...
                            public void onNewAvailableDeviceList(int[] deviceIDs, String[] deviceIdentifierStrings,
                                    int changeCode, int changingDeviceID)
                            {                                
                                deviceList_Display.clear();
