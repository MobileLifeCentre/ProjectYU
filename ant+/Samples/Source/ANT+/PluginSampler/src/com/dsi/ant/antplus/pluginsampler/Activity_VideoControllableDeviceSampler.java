...
import com.dsi.ant.plugins.antplus.pcc.AntPlusControlsPcc.IVideoCommandReceiver;
import com.dsi.ant.plugins.antplus.pcc.AntPlusControlsPcc.VideoDeviceCapabilities;
...
public class Activity_VideoControllableDeviceSampler extends Activity 
{
    ...
    private void resetPcc()
    {
        ...
        AntPlusControlsPcc.requestAccessVideoMode(this, new IPluginAccessResultReceiver<AntPlusControlsPcc>()
                {               
                    public void onResultReceived(AntPlusControlsPcc result, int resultCode, int initialDeviceStateCode)
                    {
                        switch(resultCode)
                        {
                            ...
                            case AntPluginMsgDefines.MSG_REQACC_RESULT_whatCHANNELNOTAVAILABLE:
                                Toast.makeText(Activity_VideoControllableDeviceSampler.this, "Channel Not Available", Toast.LENGTH_SHORT).show();
                            ...
                            case AntPluginMsgDefines.MSG_REQACC_RESULT_whatUSERCANCELLED:
                                ...
                                break;
                            default:
                                Toast.makeText(Activity_VideoControllableDeviceSampler.this, "Unrecognized result: " + resultCode, Toast.LENGTH_SHORT).show();
                                tv_status.setText("Error. Do Menu->Reset.");
                                break;
                        } 
                    }                    
                ...
                new IVideoCommandReceiver()
                        {
							...
							public int onNewVideoCommand(final int currentMessageCount, final int serialNumber,
 ...
 // Very rudimentary simulation just for testing, cycle through values every 2 seconds
    class SimulateDataTask extends TimerTask
    {
    	...
    	int currentTime = 0;    	
    	int deviceState = AntPlusControlsPcc.VideoDeviceState.OFF;
    	...
    	public void run()
    	{
    		...
    		if(ctrlPcc != null)
    		{
    			...
    			if(deviceState == AntPlusControlsPcc.VideoDeviceState.RECORD)
    				deviceState = AntPlusControlsPcc.VideoDeviceState.OFF;
    			else
    				deviceState++;
    		}
    	}
