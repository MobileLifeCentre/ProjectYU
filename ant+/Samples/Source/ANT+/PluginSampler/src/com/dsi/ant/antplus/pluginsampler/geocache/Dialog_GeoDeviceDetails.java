...
import com.dsi.ant.plugins.antplus.commonpages.P82_BatteryStatus.BatteryStatusCodes;
...
public class Dialog_GeoDeviceDetails extends DialogFragment
{
        ...
        button_ProgramDevice.setOnClickListener(new OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        if((deviceData.programmableData.identificationString.trim().length() != 0 //If the device itself is programmed
                                ...
                                && getDeviceBasedPIN(getActivity()) != deviceData.programmableData.PIN) //and the app's persistent PIN doesn't match the programmed one
                        {
                ...
                {        
                    ...
                    protected void onReceiveResult(int resultCode, Bundle resultData)
                    {
                        if(resultCode == 0) //Succesful programming
                        {
                            ...
                            ProgrammableGeocacheDeviceData progdData = ProgrammableGeocacheDeviceData.readFromBundle(resultData);
    ...
    {        
        ...
        textView_BatteryStatus.setText(BatteryStatusCodes.batteryStatusCodeToString(deviceData.batteryStatusCode));
